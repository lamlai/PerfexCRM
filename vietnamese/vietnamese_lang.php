...
$lang['email_header'] = 'Header định sẵn';
$lang['email_footer'] = 'Footer định sẵn';
$lang['exclude_proposal_from_client_area_with_draft_status'] = 'Loại các đề xuất mang trạng thái nháp khỏi khu vực khách hàng';
$lang['pusher_app_key'] = 'APP Key';
$lang['pusher_app_secret'] = 'APP Secret';
$lang['pusher_app_id'] = 'APP ID';
$lang['pusher_cluster_notice'] = 'Chừa trống để sử dụng pusher cluster mặc định.';
...
$lang['customer_statement_for'] = 'Báo cáo khách hàng cho %s';
$lang['account_summary'] = 'Tóm lược tài khoản';
$lang['statement_beginning_balance'] = 'Số dư khởi đầu';
$lang['invoiced_amount'] = 'Tổng báo giá';
...
$lang['balance_due'] = 'Số dư còn thiếu';
...
$lang['statement_invoice_details'] = 'Hóa đơn %s - chốt ngày %s';
$lang['statement_payment_details'] = 'Thanh toán (%s) thành hóa đơn %s';
$lang['statement_bill_to'] = 'Đến';
$lang['send_to_email']          = 'Gửi vào email';
$lang['statement_sent_to_client_success'] = 'Đã gửi thành công báo cáo đến khách hàng';
$lang['statement_sent_to_client_fail']    = 'Phát sinh lỗi khi đang gửi báo cáo';
$lang['view_account_statement']    = 'Xem báo cáo của tài khoản';
$lang['text_not_recommended_for_servers_limited_resources'] = 'Không khuyến khích nếu tài nguyên máy chủ có giới hạn. Ví dụ như hosting chung';
$lang['tasks_bull_actions_assign_notice'] = 'Nếu phân công được liên kết đến dự án và nhân viên bạn chỉ định không phải là thành viên dự án này, thì nhân viên đó sẽ tự động được thêm vào làm thành viên cho dự án.';
$lang['company_information'] = 'Thông tin công ty';
$lang['ticket_form'] = 'Mẫu yêu cầu hỗ trợ';
...
$lang['success_submit_msg'] = 'Cảm ơn bạn đã gửi yêu cầu. Chúng tôi sẽ liên hệ đến bạn nhanh chóng.';
$lang['vault_entry_share_on_projects'] = 'Chia sẻ vault entry trong dự án với các thành viên khác';
$lang['project_shared_vault_entry_login_details'] = 'Xem chi tiết đăng nhập trang khách hàng';
$lang['iso_code'] = 'Mã ISO';
$lang['estimates_not_invoiced'] = 'Chưa xuất hóa đơn';
$lang['show_on_ticket_form'] = 'Hiển thị trên mẫu yêu cầu';
$lang['cancel_upload'] = 'Hủy tải lên';
$lang['show_table_export_button'] = 'Hiển thị nút xuất danh sách';
$lang['show_table_export_all'] = 'Cho tất cả nhân viên';
$lang['show_table_export_admins'] = 'Chỉ cho người quản trị';
$lang['show_table_export_hide'] = 'Ẩn nút xuất cho tất cả nhân viên';
$lang['task_created_by'] = 'Được tạo bởi %s';
$lang['validation_extension_not_allowed'] = 'Phần mở rộng tập tin không được cho phép';
$lang['allow_staff_view_proposals_assigned'] = 'Cho phép nhân viên xem các bản đề xuất họ được chỉ định';
...
# Version 1.9.0
$lang['estimated_hours'] = 'Thời gian dự định';
$lang['two_factor_auth_failed_to_send_code'] = 'Gửi mã xác minh 2 bước vào email không thành công, cài đặt SMTP có thể chưa được định dạng chính xác';
$lang['two_factor_auth_code_sent_successfully'] = 'Email mang mã xác minh đã được gửi đến %s để xác nhận đăng nhập của bạn';
$lang['enable_two_factor_authentication'] = 'Kích hoạt Xác minh 2 bước';
$lang['two_factor_authentication_info'] = 'Xác minh 2 bước được cung cấp bởi email, trước khi kích hoạt tính năng này xin hãy chắc chắn cài đặt SMTP của bạn được định dạng hợp lý và hệ thống có thể gửi email. Mã xác minh độc nhất sẽ được gửi vào email khi đăng nhập.';
$lang['timesheets_overview_all_members_notice_admins'] = 'Tổng quan biểu đồ thời gian cho thành viên chỉ khả dụng với người quản trị.';
...
$lang['back_to_login'] = 'Quay về trang đăng nhập';
$lang['enter_activity'] = 'Tham gia hoạt động';
$lang['attach_files'] = 'Đính kèm tập tin';
$lang['no_tags_used'] = 'Hệ thống không sử dụng nhãn nào';
...
$lang['project_marked_as_finished_to_contacts'] = 'Gửi email <b>Dự án được đánh dấu hoàn thành</b> đến các liên hệ khách hàng';
$lang['only_admins'] = 'Chỉ dành cho quản trị';
$lang['new_notification'] = 'Thông báo mới!';
$lang['enable_desktop_notifications'] = 'Kích hoạt thông báo ngoài màn hình desktop';
$lang['save_and_send'] = 'Lưu & gửi';
$lang['private'] = 'Riêng tư';
$lang['task_created_at'] = 'Đã được tạo vào %s';
$lang['hide_notified_reminders_from_calendar'] = 'Ẩn nhắc nhở đã thông báo trong lịch';
$lang['last_active'] = 'Hoạt động lần cuối';
$lang['open_ticket'] = 'Mở yêu cầu';
$lang['task_add_description'] = 'Thêm mô tả';
$lang['project_setting_create_tasks'] = 'tạo phân công';
$lang['project_setting_edit_tasks'] = 'chỉnh sửa phân công (chỉ những phân công tạo từ liên hệ)';

# Version 1.9.2
$lang['items_report'] = 'Báo cáo mặt hàng';
$lang['reports_item'] = 'Mặt hàng';
$lang['quantity_sold'] = 'Số lượng đã bán';
$lang['total_amount'] = 'Tổng';
$lang['avg_price'] = 'Giá trung bình';
$lang['item_report_paid_invoices_notice'] = 'Báo cáo mặt hàng chỉ được xuất từ hóa đơn đã thanh toán chưa qua khuyến mãi và thuế.';
$lang['overview'] = 'Tổng quan';
$lang['timer_started_change_status_in_progress'] = 'Chuyển trạng thái phân công thành Đang thực hiện trên thời gian hẹn sẵn (chỉ khả dụng nếu trạng thái phân công đang là Chưa bắt đầu)';
...
$lang['custom_field_info_format_embed_info'] = 'Các mục tùy chỉnh cho %s có thể dễ dàng lồng vào văn bản PDF và HTML bằng cách thêm các mục nhập chung vào mẫu trang tại trang sau: %s';
$lang['transfer_lead_notes_to_customer'] = 'Chuyển ghi chú mục tiêu đến hồ sơ khách hàng';
$lang['authorized_signature_text'] = 'Chữ ký đã cấp quyền';
$lang['show_pdf_signature_invoice'] = 'Hiển thị chữ ký PDF trên hóa đơn';
$lang['show_pdf_signature_estimate'] = 'Hiển thị chữ ký PDF trên báo giá';
$lang['signature'] = 'Chữ ký';
$lang['signature_image'] = 'Hình chữ ký';
$lang['insert_checklist_templates'] = 'Chèn mẫu danh sách đánh dấu';
$lang['save_as_template'] = 'Lưu thành mẫu tạo sẵn';
$lang['scroll_responsive_tables_help'] = 'Bảng biểu với khối lượng dữ liệu lớn sẽ có thanh lăn ngang thay vì các dòng được bao trong dấu +.';
$lang['scroll_responsive_tables'] = 'Kích hoạt tính năng lăn responsive cho bảng';
$lang['invoice_item_add_edit_rate_currency'] = 'Tỷ giá - %s';
$lang['total_files_deleted'] = 'Tổng số tập tin đã xóa: %s';
$lang['invalid_transaction'] = 'Giao dịch không hợp lý. Xin hãy thử lại.';
$lang['payment_gateway_payu_money_key'] = 'PayU Money Key';
$lang['payment_gateway_payu_money_salt'] = 'PayU Money Salt';
$lang['settings_paymentmethod_description'] = 'Mô tả bảng tin thanh toán';

# Version 1.9.3
$lang['default_ticket_reply_status'] = 'Đã chọn trạng thái mặc định khi trả lời yêu cầu';
$lang['ticket_add_response_and_back_to_list'] = 'Quay về danh sách yêu cầu sau khi gửi trả lời';

# Version 1.9.4
$lang['default_task_status'] = 'Trạng thái mặc định khi phân công mới được tạo';
$lang['custom_field_pdf_html_help'] = 'Hãy chắc chắn bạn đã kiểm tra mục ' . $lang['custom_field_show_on_client_portal'] . ' nếu bạn muốn các mục tùy chỉnh hiển thị trong khu vực khách hàng và khi khách hàng tải hoặc nhận PDF qua email.';
$lang['auto'] = 'Tự động';
$lang['email_queue'] = 'Email Queue';
$lang['email_queue_enabled'] = 'Kích hoạt Email Queue';
$lang['email_queue_skip_attachments'] = 'Không được thêm email có định kèm vào queue.';
$lang['disable'] = 'Bỏ kích hoạt';
$lang['enable'] = 'Kích hoạt';
$lang['auto_dismiss_desktop_notifications_after'] = 'Tự động tắt thông báo màn hình desktop sau X giây (nhập 0 để bỏ kích hoạt)';
$lang['proposal_info_format'] = 'Mẫu thông tin đề xuất (PDF và HTML)';
$lang['hide_tasks_on_main_tasks_table'] = 'Ẩn các phân công dự án trên bảng phân công chính (khu vực quản trị)';
$lang['ticket_replies_order'] = 'Thứ tự trả lời yêu cầu';
$lang['ticket_replies_order_notice'] = 'Thông báo mở đầu yêu cầu sẽ luôn hiển thị trước tiên.';
$lang['invoice_cancelled_email_disabled'] = 'Hóa đơn đã hủy. Bỏ đánh dấu hủy để kích hoạt email đến khách hàng';
$lang['email_notifications'] = 'Thông báo email';
$lang['invoice_activity_record_payment_email_to_customer'] = 'Đã ghi lại thanh toán, gửi email đến: %s';
$lang['exclude_inactive'] = 'Loại trừ không hoạt động';
$lang['disable_all'] = 'Bỏ kích hoạt tất cả';
$lang['enable_all'] = 'Kích hoạt tất cả';
$lang['reccuring_invoice_option_gen_and_send'] = 'Xuất và tự động gửi hóa đơn đã gia hạn cho khách hàng';
$lang['reccuring_invoice_option_gen_unpaid'] = 'Xuất hóa đơn chưa thanh toán';
$lang['reccuring_invoice_option_gen_draft'] = 'Xuất hóa đơn nháp';
$lang['event_created_by'] = 'Sự kiện này được tạo bởi %s';

# Version 1.9.5
$lang['customers_assigned_to_me'] = 'Các khách hàng được chỉ định cho tôi';
$lang['bcc_all_emails'] = 'BCC tất cả email người nhận';
$lang['confirmation_of_identity'] = 'Xác nhận danh tính';
$lang['accept_identity_confirmation'] = 'Yêu cầu đồng ý xác nhận danh tính';
$lang['accepted_identity_info'] = '%s này được đồng ý bởi %s trên %s từ địa chỉ IP %s';
$lang['clear_this_information'] = 'Xóa thông tin này';
$lang['new_task_auto_follower_current_member'] = 'Tự động thêm người tạo phân công vào người theo dõi sau khi đã tạo';
$lang['expenses_report_net'] = 'Tổng số tịnh (Tổng phụ)';
$lang['expense_field_billable_help'] = 'Nếu xuất đơn được, %s có thể thêm vào mô tả dài của hóa đơn.';
$lang['task_biillable_checked_on_creation'] = 'Mặc định tick vào lựa chọn xuất đơn khi tạo phân công mới?';
$lang['pause_overdue_reminders'] = 'Ngừng nhắc nhở quá hạn';
...
$lang['credit_note_not_found'] = 'Không tìm thấy credit note';
$lang['credit_note_date'] = 'Ngày tạo credit note';
$lang['credit_date'] = 'Ngày';
$lang['settings_sales_next_credit_note_number'] = 'Mã số credit note tiếp theo';
$lang['credit_note_number_prefix'] = 'Số tiền tố của credit note';
$lang['credit_note_number'] = 'Credit note #';
$lang['credit_note_number_exists'] = 'Mã số credit note đã tồn tại';
$lang['show_shipping_on_credit_note'] = 'Hiển thị chi tiết giao hàng trên credit note';
$lang['credit_note_number_decrement_on_delete'] = 'Hạ số credit note xuống sau khi xóa.';
$lang['credit_note_number_decrement_on_delete_help'] = 'Mã số sẽ hạ bậc chỉ khi credit note đó vừa được tạo.';
$lang['credit_note_status'] = 'Trạng thái';
$lang['credit_note_status_open'] = 'Mở';
$lang['credit_note_status_closed'] = 'Đóng';
$lang['credit_note_status_void'] = 'Trống';
$lang['credit_note_mark_as_open'] = 'Đánh dấu Mở';
$lang['new_credit_note'] = 'Credit note mới';
$lang['credit_note_amount'] = 'Tổng';
$lang['credit_note_remaining_credits'] = 'Còn lại';
$lang['credit_note_client_note'] = 'Note';
$lang['invoices_credited'] = 'Hóa đơn đã kê khai';
$lang['apply_credits'] = 'Áp dụng kê khai';
$lang['x_credits_available'] = '%s kê khai đang khả dụng.';
$lang['credit_amount'] = 'Lượng kê khai';
$lang['credits_available'] = 'Kê khai khả dụng';
$lang['amount_to_credit'] = 'Số lượng để kê khai';
$lang['invoice_credits_applied'] = 'Đã áp dụng kê khai cho hóa đơn thành công';
$lang['applied_credits'] = 'Đã áp dụng kê khai';
$lang['credit_amount_bigger_then_invoice_balance'] = 'Tổng kê khai lớn hơn số dư cần trả trong hóa đơn';
$lang['credit_amount_bigger_then_credit_note_remaining_credits'] = 'Tổng lượng kê khai lớn hơn phần kê khai còn lại';
$lang['credited_invoices_not_found'] = 'Không tìm thấy các hóa đơn đã kê khai';
$lang['credit_invoice_number'] = 'Số hóa đơn';
$lang['credits_used'] = 'Kê khai đã dùng';
$lang['credits_remaining'] = 'Kê khai còn lại';
$lang['amount_credited'] = 'Số lượng đã kê khai';
$lang['credits_applied_cant_delete_status_closed'] = 'Credit note này mang trạng thái Đóng, trước tiên bạn cần xóa kê khai để xóa credit note này.';
$lang['credits_applied_cant_delete_credit_note'] = 'Credit note này đã áp dụng kê khai, trước tiên bạn phải xóa các kê khai để xóa credit note này.';
$lang['credit_note_pdf_heading'] = 'CREDIT NOTE';
$lang['show_status_on_pdf'] = 'Hiển thị trạng thái %s trên văn bản PDF';
$lang['show_pdf_signature_credit_note'] = 'Hiển thị Chữ ký PDF trên credit note';
$lang['calendar_credit_note_reminder'] = 'Nhắc nhở credit note';
$lang['show_credit_note_reminders_on_calendar'] = 'Nhắc nhở credit note';
$lang['reminders'] = 'Nhắc nhở';
$lang['invoice_activity_applied_credits'] = 'đã áp dụng kê khai của %s từ %s';
$lang['create_credit_note'] = 'Tạo credit note';
$lang['confirm_invoice_credits_from_credit_note'] = 'Khi tạo credit note từ hóa đơn không thanh toán, lượng credit note sẽ áp dụng cho hóa đơn này. Bạn có chắc chắn muốn tạo credit note?';
$lang['credit_invoice_date'] = 'Ngày tạo hóa đơn';
$lang['apply_to_invoice'] = 'Áp dụng cho hóa đơn';
$lang['apply_credits_from'] = 'Áp dụng kê khai từ %s';
$lang['credits_successfully_applied_to_invoices'] = 'Đã áp dụng thành công các kê khai hóa đơn';
$lang['credit_note_send_to_client_modal_heading'] = 'Gửi credit note đến khách hàng';
$lang['credit_note_sent_to_client_success'] = 'Đã gửi credit note đến khách hàng thành công';
$lang['credit_note_sent_to_client_fail']    = 'Phát sinh lỗi khi đang gửi credit note vào email';
$lang['credit_note_no_invoices_available'] = 'Không có hóa đơn khả dụng nào cho khách hàng này.';
$lang['show_total_paid_on_invoice'] = 'Hiển thị tổng thanh toán trên hóa đơn';
$lang['show_credits_applied_on_invoice'] = 'Hiển thị kê khai đã áp dụng cho hóa đơn';
$lang['show_amount_due_on_invoice'] = 'Hiển thị giá trị cần trả trên hóa đơn';
$lang['customer_profile_update_credit_notes'] = 'Cập nhật thông tin giao hàng/hóa đơn trên tất cả những credit note trước (credit note đã đóng không bị ảnh hưởng)';
$lang['zip_credit_notes'] = 'Nén credit note';
$lang['statement_credit_note_details'] = 'Credit note %s';
$lang['statement_credits_applied_details'] = 'Đã áp dụng kê khai từ credit note %s - %s cho thanh toán của %s';
$lang['credit_note_files'] = 'Tập tin credit note';
$lang['credit_notes_report'] = 'Báo cáo credit note';
$lang['credit_note_set_reminder_title'] = 'Đặt nhắc nhở credit note';
...
# Version 1.9.7
$lang['ticket_assigned'] = 'Đã được chỉ định';
$lang['dashboard_options'] = 'Quyền chọn bảng tin';
$lang['reset_dashboard'] = 'Reset bảng tin';
$lang['widgets'] = 'Widgets';
$lang['s_chart'] = 'Biểu đồ %s';
$lang['quick_stats'] = 'Số liệu sơ bộ';
$lang['user_widget'] = 'Widget của người dùng';
$lang['widgets_visibility_help_text'] = 'Widget chỉ hiển thị khi có đủ dữ liệu và không có lựa chọn ẩn hay hiển thị.';
$lang['show_project_on_estimate'] = 'Hiển thị tên dự án trên báo giá';
$lang['show_project_on_invoice'] = 'Hiển thị tên dự án trên hóa đơn';
$lang['show_project_on_credit_note'] = 'Hiển thị tên dự án trên credit note';
$lang['visible_tabs'] = 'Các tab hiển thị';
$lang['all'] = 'Tất cả';
$lang['view_widgetable_area'] = 'Xem khu vực Widgetable';
$lang['hide_widgetable_area'] = 'Ẩn khu vực Widgetable';
$lang['no_items_warning'] = 'Nhập ít nhất một mục.';
$lang['item_forgotten_in_preview'] = 'Bạn đã quên thêm mục này phải không?';
$lang['not_task_status_changed'] = '%s - trạng thái phân công đã chuyển thành %s';
$lang['not_project_activity_task_status_changed'] = 'Đã chuyển trạng thái phân công';
$lang['reset'] = 'Reset';
$lang['save_message_as_predefined_reply'] = 'Lưu tin nhắn thành phản hồi định sẵn';
$lang['inline_create_option'] = 'Cho phép thành viên không phải quản trị tạo %s trong mục tạo/sửa của %s?';
$lang['inline_create'] = 'Tạo theo hàng';
$lang['inline_create_option_predefined_replies'] = 'Cho phép nhân viên không phải quản trị lưu phản hồi định sẵn từ tin nhắn yêu cầu hỗ trợ';
$lang['reminders_view_none_admin'] = 'Hiển thị nhắc nhở cho bạn và nhắc nhở được tạo bởi bạn.';
$lang['show_tabs_and_options'] = 'Hiển thị các tab & lựa chọn';
$lang['no_milestones_found'] = 'Dự án này không có cột mốc nào';
$lang['lead_is_contact_create_task'] = 'Tạo phân công nếu người gửi email là khách hàng và chỉ định cho nhân viên đảm nhiệm.';
$lang['existing_customer'] = 'Khách hàng đang tồn tại';
$lang['use_company_name_instead'] = 'Sử dụng tên công ty';
$lang['customer_delete_transactions_warning'] = 'Khách hàng này có giao dịch, %s, bạn phải xóa các giao dịch hoặc chuyển chúng qua khách hàng khác để thực hiện hành động này.';

# Version 1.9.8
$lang['sending_email_contact_permissions_warning'] =  'Tự động chọn liên hệ khách hàng thất bại. Hảy đảm bảo khách hàng đó có liên hệ khả dụng và liên hệ có thông báo email để kích hoạt %s.';
$lang['help_leads_create_permission'] = 'Tất cả nhân viên có thể tạo đối tượng khách hàng, ngoại trừ những người được đánh dấu không phải nhân viên';
$lang['help_leads_edit_permission'] = 'Những ai có quyền truy cập đối tượng nhất định đều có thể chỉnh sửa phần lớn thông tin về đối tượng';
$lang['triggers'] = 'Triggers';
$lang['notice_only_one_active_sms_gateway'] = 'Chỉ cho phép duy nhất 1 cổng SMS hoạt động';
$lang['sms_trigger_disable_tip'] = 'Để trống nếu muốn hủy kích hoạt trigger nhất định.';
$lang['tables'] = 'Bảng';
$lang['only_project_tasks'] = 'Chỉ những phân công liên quan đến dự án';
$lang['download_all'] = 'Tải xuống tất cả';
$lang['settings_sales_credit_note_number_format'] = 'Định dạng mã số credit note';
$lang['sms_reminder_sent_to'] = 'Đã gửi nhắc nhở SMS đến %s';
$lang['ideal_customer_statement_descriptor'] = 'Mô tả xác nhận (hiển thị trong xác nhận nhà băng của khách hàng)';
$lang['payment_received_awaiting_confirmation'] = 'Thanh toán của bạn đã được gửi đi và đang chờ xác nhận.';
$lang['discount_fixed_amount'] = 'Tổng cố định';
$lang['timesheet_duration_instead'] = 'Nhập thời hạn';
$lang['timesheet_date_instead'] = 'Đặt thời gian bắt đầu và kết thúc';
$lang['allow_non_admin_members_to_import_leads'] = 'Cho phép nhân viên không phải quản trị nhập đối tượng khách hàng';
$lang['project_hide_tasks_settings_info'] = 'Các phân công được loại khỏi bảng phân công chính cho dự án này, bạn có thể xem các phân công chỉ riêng cho dự án ở khu vực này.';
