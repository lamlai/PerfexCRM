...
# Tickets
$lang['clients_ticket_open_subject']                = 'Yêu cầu hỗ trợ';
...
# Version 1.8.0
$lang['not_customer_viewed_invoice'] = 'Hóa đơn mang số %s đã được xem';
$lang['not_customer_viewed_estimate'] = 'Báo giá mang số %s đã được xem';
$lang['not_customer_viewed_proposal'] = 'Đề xuất kế hoạch mang số %s đã được xem';
$lang['display_inline'] = 'Hiển thị trong hàng';
$lang['email_header'] = 'Tiêu đề được định nghĩa trước';
$lang['email_footer'] = 'Footer được định nghĩa trước';
$lang['exclude_proposal_from_client_area_with_draft_status'] = 'Loại trừ đề xuất mang trạng thái nháp khỏi khu vực khách hàng';
$lang['pusher_app_key'] = 'Mã APP';
$lang['pusher_app_secret'] = 'Mã APP bí mật';
$lang['pusher_app_id'] = 'APP ID';
$lang['pusher_cluster_notice'] = 'Bỏ trống để sử dụng pusher cluster mặc định.';
$lang['pusher_enable_realtime_notifications'] = 'Kích hoạt thông báo thời gian thực';
$lang['task_is_overdue'] = 'Phân công này đã quá hạn';
$lang['this_year'] = 'Năm này';
$lang['last_year'] = 'Năm trước';
$lang['customer_statement'] = 'Điều khoản';
$lang['customer_statement_for'] = 'Điều khoản khách hàng cho %s';
$lang['account_summary'] = 'Tóm lược tài khoản';
$lang['statement_beginning_balance'] = 'Số dư ban đầu';
$lang['invoiced_amount'] = 'Tổng số hóa đơn';
$lang['amount_paid'] = 'Tổng số đã trả';
...
$lang['statement_heading_amount'] = 'Tổng số';
$lang['statement_heading_payments'] = 'Thanh toán';
$lang['statement_heading_balance'] = 'Số dư';
$lang['statement_invoice_details'] = 'Hóa đơn %s - còn nợ %s';
$lang['statement_payment_details'] = 'Thanh toán (%s) cho hóa đơn %s';
$lang['statement_bill_to'] = 'Đến';
$lang['send_to_email']          = 'Gửi đến email';
$lang['statement_sent_to_client_success'] = 'Điều khoản được gửi đến khách hàng thành công';
$lang['statement_sent_to_client_fail']    = 'Xảy ra trục trặc trong lúc gửi điều khoản';
$lang['view_account_statement']    = 'Xem điều khoản của tài khoản';
$lang['text_not_recommended_for_servers_limited_resources'] = 'Không khuyến khích nếu máy chủ có tài nguyên giới hạn. Ví dụ như hosting chung';
$lang['tasks_bull_actions_assign_notice'] = 'Nếu phân công được dẫn đến dự án và nhân viên bạn chỉ định không phải là thành viên thuộc dự án thì nhân viên này sẽ tự động được chuyển thành thành viên.';
$lang['company_information'] = 'Thông tin công ty';
$lang['ticket_form'] = 'Mẫu yêu cầu';
...
$lang['ticket_form_priority'] = 'Ưu tiên';
$lang['ticket_form_service'] = 'Dịch vụ';
$lang['ticket_form_submit'] = 'Gửi đi';
$lang['ticket_form_attachments'] = 'Đính kèm';
$lang['success_submit_msg'] = 'Cảm ơn bạn đã gửi yêu cầu đến chúng tôi. Chúng tôi sẽ nhanh chóng liên hệ lại với bạn.';
$lang['vault_entry_share_on_projects'] = 'Chia sẻ vault này trong dự án với các thành viên trực thuộc';
$lang['project_shared_vault_entry_login_details'] = 'Xem chi tiết đăng nhập ở trang khách hàng';
$lang['iso_code'] = 'Mã ISO';
$lang['estimates_not_invoiced'] = 'Chưa chuyển thành hóa đơn';
$lang['show_on_ticket_form'] = 'Hiển thị trên mẫu yêu cầu';
$lang['cancel_upload'] = 'Hủy đăng tải';
$lang['show_table_export_button'] = 'Hiển thị nút xuất bảng biểu';
$lang['show_table_export_all'] = 'Đến tất cả nhân viên';
$lang['show_table_export_admins'] = 'Chỉ người quản trị';
$lang['show_table_export_hide'] = 'Ẩn nút xuất với tất cả nhân viên';
$lang['task_created_by'] = 'Được tạo bởi %s';
$lang['validation_extension_not_allowed'] = 'Phần mở rộng không hợp lệ';
$lang['allow_staff_view_proposals_assigned'] = 'Cho phép nhân viên xem các đề xuất được chỉ định';
$lang['task_users_working_on_tasks_multiple'] = '%s hiện đang thực hiện phân công này';
$lang['task_users_working_on_tasks_single'] = '%s hiện đang thực hiện phân công này';

# Version 1.9.0
$lang['estimated_hours'] = 'Thời gian dự tính';
$lang['two_factor_auth_failed_to_send_code'] = 'Gửi Xác minh 2 bước đến email thất bại, cài đặt SMTP có thể không được định dạng chính xác';
$lang['two_factor_auth_code_sent_successfully'] = 'Đã gửi email chứa mã xác minh đến %s để xác nhận đăng nhập của bạn';
$lang['enable_two_factor_authentication'] = 'Kích hoạt Xác minh 2 bước';
$lang['two_factor_authentication_info'] = 'Xác minh 2 bước được cung cấp bởi email, trước khi kích hoạt hãy chắc chắn rằng cài đặt SMTP của bạn được định dạng chính xác và hệ thống có thể gửi email. Mã xác minh độc nhất sẽ được gửi đến email ngay khi đăng nhập.';
$lang['timesheets_overview_all_members_notice_admins'] = 'Tổng quan biểu đồ thời gian thi công của nhân viên chỉ khả dụng với người quản trị.';
$lang['two_factor_authentication'] = 'Xác minh 2 bước';
$lang['two_factor_authentication_code'] = 'Mã';
$lang['admin_two_factor_auth_heading'] = 'Mã xác minh';
$lang['two_factor_code_not_valid'] = 'Mã xác minh không hợp lệ';
$lang['back_to_login'] = 'Quay lại đăng nhập';
$lang['enter_activity'] = 'Enter Activity';
$lang['attach_files'] = 'Các tập tin đính kèm';
$lang['no_tags_used'] = 'Không nhãn nào được sử dụng bởi hệ thống';
$lang['exclude_completed_tasks'] = 'Loại những phân công đã hoàn thành';
...
$lang['contract_copied_fail'] = 'Sao chép hợp đồng thất bại';
$lang['project_marked_as_finished_to_contacts'] = 'Gửi email <b>dự án được đánh dấu hoàn thành</b> đến liên hệ khách hàng';
$lang['only_admins'] = 'Chỉ người quản trị';
$lang['new_notification'] = 'Thông báo mới!';
$lang['enable_desktop_notifications'] = 'Kích hoạt thông báo trên màn hình desktop';
$lang['save_and_send'] = 'Lưu và gửi';
$lang['private'] = 'Riêng tư';
$lang['task_created_at'] = 'Đã tạo lúc %s';
$lang['hide_notified_reminders_from_calendar'] = 'Ẩn các nhắc nhở đã thông báo khỏi lịch';
$lang['last_active'] = 'Hoạt động lần cuối';
$lang['open_ticket'] = 'Yêu cầu chưa giải quyết';
$lang['task_add_description'] = 'Thêm mô tả';
$lang['project_setting_create_tasks'] = 'tạo các phân công';
$lang['project_setting_edit_tasks'] = 'chỉnh sửa các phân công (chỉ những phân công được tạo từ liên hệ)';
